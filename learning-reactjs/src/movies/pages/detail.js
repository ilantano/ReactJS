      ...
      <Row style={{marginTop:'20px', marginBottom:'20px'}}>
        <Col span={6}>
          <Card
            hoverable
            style={{ width: 300 }}
            cover={<img alt={detailMovie.title} src={`https://image.tmdb.org/t/p/w200/${detailMovie.poster_path}`} />}
          >
        ...
        <Col span={6}>
          ...
          {detailMovie.images !== undefined ? detailMovie.images.backdrops.map((item, index)=>(
              ...
              <Card
                ...
                bordered={false}
                style={{ width: 300 }}
                cover={<img alt={detailMovie.title} src={`https://image.tmdb.org/t/p/w200/${item.file_path}`} />}
              >
              </Card>
            </Col>    
          )) : null}
